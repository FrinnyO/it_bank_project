...
from src.reader import excel_reader, csv_reader
from src.widget import get_date, mask_account_card
from src.generators import filter_by_currency, filter_by_currency_for_csv_excel
from src.utils import get_transactions_and_descriptions
...
def file_choice() -> List[dict]:
    ...
    3. Получить информацию о транзакциях из XLSX-файла\n"""
        ...
        if user_choice == "1":
            ...
            transaction_info = get_transactions_and_descriptions("../data/operations.json")
        elif user_choice == "2":
            print("Для обработки выбран CSV-файл.\n")
            transaction_info = csv_reader("../data/transactions.csv")
        elif user_choice == "3":
            print("Для обработки выбран XLSX-файл.\n")
            transaction_info = excel_reader("../data/transactions_excel.xlsx")
        else:
